...
__author__ = 'ana.freitas@ime.eb.br'
__date__ = '2026-08-19'
__copyright__ = 'Copyright 2026, Ana Freitas'
...
from TOPODATA_Dowloader_dialog import TOPODATADowloaderDialog
...
class TOPODATADowloaderDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = TOPODATADowloaderDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(TOPODATADowloaderDialogTest)
