...
SOURCES = \
	__init__.py \
	TOPODATA_Dowloader.py TOPODATA_Dowloader_dialog.py

PLUGINNAME = TOPODATA_Dowloader

PY_FILES = \
	__init__.py \
	TOPODATA_Dowloader.py TOPODATA_Dowloader_dialog.py

UI_FILES = TOPODATA_Dowloader_dialog_base.ui
...
QGISDIR=C:\Users\anapm\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
